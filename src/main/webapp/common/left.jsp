...
<div class="col-sm-3 col-md-2 sidebar">
	<ul class="nav nav-sidebar">
		...
		<li class="active"><a href="/userPageList?page=1&pageSize=10">사용자 페이지 리스트</a></li>
		<li class="active"><a href="/userDetail">사용자 정보조회</a></li>
		<li class="active"><a href="user/userEdit.jsp">사용자 정보조회</a></li>
		<li class="active"><a href="/prod/prod_list.jsp?page=1&pageSize=10">제품 리스트</a></li>
