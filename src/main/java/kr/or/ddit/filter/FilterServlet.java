...
public class FilterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("2filter servlet doGet");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//character encoding 설정을 filter 로 이관 (코드 중복 제거) 
		...
		//request forword(/filter/view.jsp)
		//request.getRequestDispatcher("/filter/view.jsp").forward(request, response);
		response.sendRedirect("/filter/requestCount.jsp");
